...
require_once "service/adm/adm_admsesi_Service.php";

class Adm_SesiController extends Zend_Controller_Action {
	private $serv_ref;
	private $userlog;
	private $userid;	
    ...
    public function init() {
		...
		$this->datasesi_serv = adm_admsesi_Service::getInstance();
    ...
    public function sesilistAction() {
    ...
    public function sesiubahAction() {
		...
		$this->_helper->viewRenderer('sesi');	
		$this->view->par ='ubah';
    }	
    public function sesijsAction() {
    ...
    public function maintaindataAction() {
		...
		$this->_helper->viewRenderer('sesilist');		
